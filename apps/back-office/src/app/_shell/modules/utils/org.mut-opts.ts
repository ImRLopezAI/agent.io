 ...
 * Query v5 mutation-options object from the procedure's `mutationOptions()`
 * with the canonical optimistic lifecycle:
 *
...
export function membersUpdateRoleOpts(
	...
	return $rpc.workOs.members.updateRole.mutationOptions({
...
export function membersRemoveOpts($rpc: Api, qc: QueryClient, key: QueryKey) {
	return $rpc.workOs.members.remove.mutationOptions({
...
export function invitationsSendOpts($rpc: Api, qc: QueryClient, key: QueryKey) {
	return $rpc.workOs.invitations.send.mutationOptions({
...
export function invitationsRevokeOpts(
	...
	return $rpc.workOs.invitations.revoke.mutationOptions({
...
export function invitationsResendOpts(
	...
	return $rpc.workOs.invitations.resend.mutationOptions({
