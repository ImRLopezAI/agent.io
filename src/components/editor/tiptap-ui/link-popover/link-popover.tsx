...
import { ButtonGroup } from '#/components/editor/tiptap-ui-primitive/button-group'
import {
	Card,
	CardBody,
	CardItemGroup,
} from '#/components/editor/tiptap-ui-primitive/card'
import { Input } from '#/components/editor/tiptap-ui-primitive/input'
import {
	Popover,
	PopoverContent,
	PopoverTrigger,
			...
			<CardBody style={isMobile ? { padding: 0 } : {}}>
				<CardItemGroup orientation='horizontal'>
					<Input
						...
						autoCorrect='off'
						autoCapitalize='off'
						className='min-w-48 border-0 bg-transparent pr-0 focus:ring-0'
					/>
