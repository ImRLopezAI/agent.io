...
// --- Icons ---
import { Redo2Icon } from '#/components/editor/tiptap-icons/redo2-icon'
import { Undo2Icon } from '#/components/editor/tiptap-icons/undo2-icon'
// --- Hooks ---
	...
	const canExecute =
		useEditorState({
			...
			selector: ({ editor: activeEditor }) =>
				canExecuteUndoRedoAction(activeEditor, action),
		}) ?? false
