	...
	function TooltipContent(
		...
		const content = (
			<div
				...
				className={cn(
					'z-50 flex max-w-64 items-center gap-2 rounded-lg bg-foreground px-2.5 py-1.5 font-medium text-background text-xs leading-5 shadow-lg [&_kbd]:inline-flex [&_kbd]:h-5 [&_kbd]:min-w-5 [&_kbd]:items-center [&_kbd]:justify-center [&_kbd]:rounded-md [&_kbd]:border [&_kbd]:border-background/15 [&_kbd]:bg-background/10 [&_kbd]:px-1 [&_kbd]:font-mono [&_kbd]:text-[0.6875rem]',
					className,
				)}
			>
				{children}
