...
type AnyOnValueChange = (value: any, ...rest: any[]) => void

type SelectRootProps<Value> = Omit<
	SelectPrimitive.Root.Props<Value>,
	'onValueChange'
> & {
	onValueChange?: AnyOnValueChange
}

function Select<Value>({ onValueChange, ...props }: SelectRootProps<Value>) {
	return (
